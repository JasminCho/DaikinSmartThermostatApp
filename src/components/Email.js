...
const Email = ({ navigation }) => (
  <KeyboardAvoidingView style={styles.container} behavior="padding">
    ...
    <TextInput style={styles.inputBox} underlineColorAndroid='rgba(0,0,0,0)' placeholder="email@address.com" placeholderTextColor='#bdbdbd'/>
    <TextInput style={styles.inputBox} underlineColorAndroid='rgba(0,0,0,0)' placeholder="confirm email@address.com" placeholderTextColor='#bdbdbd'/>
